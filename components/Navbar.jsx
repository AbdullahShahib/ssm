...
export default function Navbar() {
    useEffect(() => {
        ...
        const cleanups = [];
        const logoTruus = document.querySelector('.logo-socialinsights-smm');
                ...
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            ...
                            <span className="logo-work-text">portfolio</span>
                        </div>
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/68a46f25779a71fac3a11903_SnapInsta.jpg" loading="eager" alt="Campaign launch mockup" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">launch strategy</span>
                                        <h4 className="nav-work-title">scroll-stopping launch system</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/6880a344675f3a6144ed04df_01_HEMA_Back2School.avif" loading="eager" alt="Monthly content calendar mockup" sizes="100vw" srcSet="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/6880a344675f3a6144ed04df_01_HEMA_Back2School-p-500.avif 500w, https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/6880a344675f3a6144ed04df_01_HEMA_Back2School.avif 1080w" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">content plan</span>
                                        <h4 className="nav-work-title">monthly content calendar</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/686b7e0ed3ab3045b28a2012_3.avif" loading="eager" alt="Creator collaboration mockup" sizes="100vw" srcSet="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/686b7e0ed3ab3045b28a2012_3-p-500.avif 500w, https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/686b7e0ed3ab3045b28a2012_3.avif 1080w" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">community</span>
                                        <h4 className="nav-work-title">community management system</h4>
                                    </div>
                                </div>
                                <a href="#" className="nav-work-btn"><span className="nav-work-btn__text">View portfolio</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="nav-center" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <svg className="logo-socialinsights-smm" width="150" height="40" viewBox="0 0 150 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">book a call</h4>
                                <p className="nav-wa-desc">Scan the QR code to start a project conversation or request a content plan.</p>
                                <a href="#" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Request on desktop</span>
